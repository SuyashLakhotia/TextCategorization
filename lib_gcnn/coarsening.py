...
def metis(W, levels, rid=None):
    ...
    parents[i] is a vector of size N_i with entries ranging from 1 to N_{i+1} which indicate
        the parents in the coarser graph[i+1]
    ...
    for parent in parents[::-1]:
        ...
        for i in indices[-1]:
            ...
            # Add two nodes as children of a singleton in the parent.
                ...
                pool_singletons += 2
                # print('singleton childrens: {}'.format(indices_node))
